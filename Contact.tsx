          ...
          <div className="reveal reveal-delay-1">
            ...
            >
              ...
              <div style={{ display: "flex", gap: 32, marginTop: 8, flexWrap: "wrap" }}>
                <div>
                  <div className="font-display" style={{ fontSize: 26, fontWeight: 800, color: "#fff" }}>%25</div>
                  <div style={{ fontSize: 11, color: "#888", letterSpacing: 1, textTransform: "uppercase", marginTop: 2 }}>Güç Artışı</div>
                </div>
                <div>
                  <div className="font-display" style={{ fontSize: 26, fontWeight: 800, color: "#fff" }}>%15</div>
                  <div style={{ fontSize: 11, color: "#888", letterSpacing: 1, textTransform: "uppercase", marginTop: 2 }}>Yakıt Tasarrufu</div>
                </div>
                <div>
